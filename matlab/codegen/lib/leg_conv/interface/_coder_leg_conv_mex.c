...
void mexFunction(int32_T nlhs, mxArray *plhs[], int32_T nrhs,
                 const mxArray *prhs[])
{
  static const char_T *emlrtEntryPoints[4] = {"leg_conv", "leg_pos", "leg_spd",
                                              "lqr_k"};
  emlrtStack st = {
      NULL, /* site */
      NULL, /* tls */
  ...
  case 0:
    unsafe_leg_conv_mexFunction(nlhs, plhs, nrhs - 1, &prhs[1]);
    break;
  case 1:
    unsafe_leg_pos_mexFunction(nlhs, plhs, nrhs - 1, &prhs[1]);
    break;
  case 2:
    unsafe_leg_spd_mexFunction(nlhs, plhs, nrhs - 1, &prhs[1]);
    break;
  case 3:
    unsafe_lqr_k_mexFunction(nlhs, plhs, nrhs - 1, &prhs[1]);
    break;
  }
  /* Module termination. */
  leg_conv_terminate();
...
/*
 * File trailer for _coder_leg_conv_mex.c
 *
 * [EOF]
 */
